...
export default function EditJobPage() {
  ...
  const fetchJob = async () => {
    ...
    try {
      ...
      // Vérifier si l'offre peut être modifiée
      if (jobData.status !== 'DRAFT') {
        setError('Cette offre ne peut pas être modifiée car elle a déjà été publiée.');
        setLoading(false);
        return;
      }
          ...
          <div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-5 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"
                placeholder="Listez les exigences requises..."
              />
            </div>
          </div>
