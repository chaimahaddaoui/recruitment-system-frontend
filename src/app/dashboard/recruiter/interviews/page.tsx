...
export default function RecruiterInterviewsPage() {
  ...
  const fetchInterviews = async () => {
    try {
      ...
      // Filtrer seulement les entretiens TECHNICAL
      ...
      <header className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-blue-600">📅 Mes Entretiens Techniques</h1>
              <p className="text-gray-600 mt-1">Gérez vos entretiens techniques</p>
            </div>
            <Link
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredInterviews.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <p className="text-gray-600">Vous n'avez pas d'entretiens techniques {filter === 'upcoming' ? 'à venir' : filter === 'past' ? 'passés' : ''}.</p>
          </div>
        ) : (
